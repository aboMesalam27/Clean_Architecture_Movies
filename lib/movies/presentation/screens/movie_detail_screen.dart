...
import 'package:osama_elgendy_movies/movies/presentation/controller/movie_details/movie_details_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<MovieDetailsBloc>()
        ...
        ..add(GetMovieRecommendedEvent(id: id)),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.movieDetails!.genresList)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
      ...
      builder: (context, state) {
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return FadeInUp(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: AppConstant.imageUrl(recommendation.backDrpPath!),
            ...
            childCount: state.recommendationsList!.length,
          ),
